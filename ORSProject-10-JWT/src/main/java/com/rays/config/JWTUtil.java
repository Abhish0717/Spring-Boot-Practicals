...
public class JWTUtil {
	...
	// Generate JWT token
	// -------------------------
	public String generateToken(Long userId, String login, String role) throws Exception {
		...
		payload.put("sub", login); // loginId as subject
	...
	// Validate JWT token
	// -------------------------
	public boolean validateToken(String token, String expectedlogin) throws Exception {
		...
		String tokenlogin = extractField(payloadJson, "sub");
		...
		if (!expectedlogin.equals(tokenlogin)) {
